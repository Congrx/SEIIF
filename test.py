...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='pretrain/LF-InterNet/InterNet_2xSR_5x5.pth.tar')
        ...
        for u in range(numU):
            for v in range(numV):
                ...
                with torch.no_grad():
                    ...
                    out = net(tmp.to(cfg.device),h_input*cfg.upscale_factor//cfg.angRes,w_input*cfg.upscale_factor//cfg.angRes,cfg.upscale_factor)
